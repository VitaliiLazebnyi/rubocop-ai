...
module IRB::Notifier
  class << self
    # pkg:gem/yard#lib/yard/parser/ruby/legacy/irb/slex.rb:23
    def def_notifier(*args); end

    # pkg:gem/yard#lib/yard/parser/ruby/legacy/irb/slex.rb:25
    def exec_if(*args, &block); end

    # pkg:gem/yard#lib/yard/parser/ruby/legacy/irb/slex.rb:28
    def level=(value); end

    # pkg:gem/yard#lib/yard/parser/ruby/legacy/irb/slex.rb:24
    def pp(*args); end

    # pkg:gem/yard#lib/yard/parser/ruby/legacy/irb/slex.rb:26
    def printf(*args); end

    # pkg:gem/yard#lib/yard/parser/ruby/legacy/irb/slex.rb:27
    def puts(*args); end
  end
end
